require('proof')(5, okay => {
    ...
    log.arrive(0)
    log.push({ version: 0n, node: 0, index: 0, value: 0 })
    log.arrive(1)
    log.push({ version: 1n, node: 0, index: 0, value: 1 })
    log.push({ version: 1n, node: 0, index: 1, value: 2 })
    log.arrive(2)
    log.push({ version: 2n, node: 0, index: 0, value: 3 })
    log.advance(2, 1n)
    log.advance(0, 0n)
    log.advance(1, 0n)
    const replay = []
    ...
    okay(replay, [{
        version: 1n, node: 0, index: 1, value: 2
    }, {
        version: 2n, node: 0, index: 0, value: 3
    }], 'replay')
    okay(log.minimum(), 0n, 'minimum')
    okay(entries.splice(0), [{
        version: 0n, node: 0, index: 0, value: 0
    }, {
